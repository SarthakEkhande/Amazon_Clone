  ...
  return (
    <div className='w-full px-4 h-[36px] bg-black text-white flex items-center'>
      <ul className='flex items-center gap-2 text-sm tracking-wide' >
        ...
        <li className='headerHover  items-center gap-1'>Todays deals</li>
        <li className='headerHover  items-center gap-1'>Customer Servive</li>
        <li className='headerHover  items-center gap-1'></li>
        <li className='headerHover  items-center gap-1'></li>
        <li className='headerHover  items-center gap-1'></li>
      </ul>
        ...
        Sidebar &&(
            <div className='w-full h-screen text-black fixed top-0 left-0 bg-amazon_blue bg-opacity-50'>
                <div className='w-full h-full relative'>
                    <motion.div ref={ref} initial={{x:-500,opacity:0}} animate={{x:0, opacity:1}} transition={{duration:.2}} className='w-[350px] h-full bg-white border border-black'>
